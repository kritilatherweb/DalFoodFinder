...
const Testimonials = () => {
  return (
    <div className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Real Customer Success Stories</p>
...
<div className='flex flex-wrap justify-center gap-8'>
        {testimonialsData.map((testimonial, index)=>(
          ...
          <img className='w-20 h-20 rounded-full mx-auto mb-8' src={testimonial.image} alt={testimonial.alt} />
               <h2 className='text-xl text-gray-700 font-medium'>{testimonial.name}</h2>
               <p className='text-gray-500 mb-4 text-sm'>{testimonial.title}              
               </p>
